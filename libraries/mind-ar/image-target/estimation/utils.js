...
const screenToMarkerCoordinate = (modelViewProjectionTransform, sx, sy) => {
  const c11 =
    modelViewProjectionTransform[2][0] * sx - modelViewProjectionTransform[0][0]
  const c12 =
    modelViewProjectionTransform[2][1] * sx - modelViewProjectionTransform[0][1]
  const c21 =
    modelViewProjectionTransform[2][0] * sy - modelViewProjectionTransform[1][0]
  const c22 =
    modelViewProjectionTransform[2][1] * sy - modelViewProjectionTransform[1][1]
  const b1 =
    modelViewProjectionTransform[0][3] - modelViewProjectionTransform[2][3] * sx
  const b2 =
    modelViewProjectionTransform[1][3] - modelViewProjectionTransform[2][3] * sy
